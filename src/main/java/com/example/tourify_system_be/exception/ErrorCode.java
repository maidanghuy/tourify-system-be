...
public enum ErrorCode {
    ...
    ROLE_ALLOWED_ADMIN(1025, "Only Admin has permission to perform this function", HttpStatus.UNAUTHORIZED),
    ...
    PLACE_HAS_TOUR(1046,"Place has tour",HttpStatus.BAD_REQUEST),
    ;
