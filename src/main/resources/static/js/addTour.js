document.addEventListener("DOMContentLoaded", () => {
    // Chỉ load data & select2 khi đúng page Add Tour
    ...
    async function loadPlacesAndCategories() {
        ...
        // Nếu không tìm thấy 2 select (không phải trang Add Tour) → dừng
        if (!categorySelect || !placeSelect) return;
        // XÓA hết option cũ
        ...
        // Setup lại Select2 (sau khi đã append option) — chỉ khi select2 đã load
